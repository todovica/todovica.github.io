...
function PrivacyPolicy() {
    return (<div>
      <h2>Privacy Policy</h2> <p>
        Rock And Friends built the Rock &amp; Friends app as
        a Free app. This SERVICE is provided by
        Rock And Friends at no cost and is intended for
        use as is.
      </p> <p>
        ...
        Rock &amp; Friends unless otherwise defined in this Privacy
        Policy.
      </p> <p><strong>Information Collection and Use</strong></p> <p>
        For a better experience, while using our Service,
        we may require you to provide us with certain
        personally identifiable information, including but not limited to email, profile photo, location. The
